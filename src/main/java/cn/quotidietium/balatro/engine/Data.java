...
public final class Data {
    ...
    public static final java.util.List<Voucher> VOUCHERS = java.util.List.of(
            ...
            new Voucher("hieroglyph", "象形文字", "底注 -1", 10, "petroglyph", null),
            new Voucher("petroglyph", "岩画", "底注再 -1", 10, null, "hieroglyph"),
    ...
    public static final java.util.List<Challenge> CHALLENGES = java.util.List.of(
            ...
            new Challenge("double", "孤注一掷", "每回合只有 1 次出牌机会；目标分减半"),
            new Challenge("typecast", "刻板印象", "牌组只有黑桃与红桃"),
            new Challenge("inflation", "通货膨胀", "商店价格每回合 +$1"),
            new Challenge("bram", "布拉姆扑克", "所有数字牌变为人头牌"),
            new Challenge("fragile", "易碎品", "玻璃牌破碎概率翻倍；玻璃牌出现率提升"),
            new Challenge("monolith", "巨石阵", "牌组全部由石头牌组成"),
            new Challenge("blastoff", "点火升空", "开局拥有「火箭」与 $0"),
            new Challenge("fivecard", "五张抽牌", "每次必须出满 5 张牌"),
            new Challenge("golden", "金针", "每回合只有 1 次出牌机会，且奖励金 ×3"),
            new Challenge("cruelty", "残酷", "小盲注与大盲注的奖励金减半"),
            new Challenge("jokerless", "无丑之地", "无法获得任何小丑牌")
    );
}
