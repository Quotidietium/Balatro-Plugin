...
public final class Data {
    ...
    public static final java.util.List<Tag> TAGS = java.util.List.of(
            ...
            new Tag("uncommon", "罕见标签", "下个商店必有一张免费罕见小丑"),
            new Tag("rare", "稀有标签", "下个商店必有一张免费稀有小丑"),
            new Tag("negative", "负片标签", "下个商店必有一张免费负片小丑"),
            new Tag("foil", "闪膜标签", "下个商店必有一张免费闪膜小丑"),
            new Tag("holo", "镭射标签", "下个商店必有一张免费镭射小丑"),
            new Tag("poly", "多彩标签", "下个商店必有一张免费多彩小丑"),
            new Tag("invest", "投资标签", "击败下一个 Boss 盲注后获得 $25"),
            new Tag("voucher", "优惠券标签", "下个商店出现一张优惠券"),
            new Tag("boss", "老板标签", "重新随机本底注的 Boss 盲注"),
            new Tag("standard", "标准标签", "立即免费开启一个巨型标准补充包（5 选 2）"),
            new Tag("charm", "魅力标签", "立即免费开启一个巨型塔罗补充包（5 选 2）"),
            new Tag("meteor", "流星标签", "立即免费开启一个巨型星球补充包（5 选 2）"),
            new Tag("buffoon", "小丑标签", "立即免费开启一个巨大小丑补充包（4 选 2）"),
            new Tag("handy", "手套标签", "立即获得 $1 × 本局已出牌次数"),
            new Tag("garbage", "垃圾标签", "立即获得 $1 × 本局未使用的弃牌次数"),
            new Tag("ethereal", "幽冥标签", "立即免费开启一个幻灵补充包"),
            ...
            new Tag("economy", "经济标签", "持有金钱翻倍（至多 +$40）"),
    ...
    public static final java.util.List<Challenge> CHALLENGES = java.util.List.of(
            ...
            new Challenge("city15", "十五分钟城市", "所有人头牌翻倍（替换所有 A、2、3）；开局拥有永恒的「搭便车」与「捷径」"),
            ...
            new Challenge("bram", "布拉姆扑克", "商店无小丑；开局永恒「吸血鬼」与「皇帝」「皇后」塔罗、「魔术技巧」「幻觉」两券"),
            new Challenge("fragile", "易碎品", "开局两张永恒负片「全是 6」；全牌组玻璃；非玻璃牌来源全数禁入"),
            new Challenge("monolith", "巨石阵", "开局永恒「方尖碑」与永恒负片「大理石小丑」；标准牌组"),
            new Challenge("blastoff", "点火升空", "每回合 2 出牌 2 弃牌、4 小丑槽；开局永恒「星座」「火箭」与「星球商人」「星球大亨」两券；「窃贼」小丑与「补给手」「顺手牵羊」券禁入"),
            new Challenge("fivecard", "五张抽牌", "每回合 6 弃牌、手牌上限 5、7 小丑槽；开局「老千」与「小丑」；手牌上限类小丑禁入"),
            new Challenge("golden", "金针", "弃牌各花 $1；每回合 1 出牌 6 弃牌；开局 $10 与「信用卡」；「窃贼」小丑与「补给手」「顺手牵羊」券禁入"),
            new Challenge("cruelty", "残酷", "小盲与大盲注均无奖励金；仅 3 小丑槽"),
            new Challenge("jokerless", "无丑之地", "商店无小丑且 0 小丑槽；一切获得小丑的来源（审判/幽灵/灵魂/产出标签/丑牌包/反物质券）禁入")
    );
}
